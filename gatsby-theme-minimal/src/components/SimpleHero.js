    ...
    <Box
      sx={{
        ...
        alignItems: 'flex-end'
          ...
          <Text variant="heading" as="h1" sx={{color: 'white', fontSize: [5,5,6], textTransform: 'uppercase', fontFamily: 'heading', margin: '0', mb: 2, bg: 'rgba(0,0,0,.3)', paddingY: 2, paddingX: 3}} >{pageTitle}</Text>
      </Box>
  );
};
